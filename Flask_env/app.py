...
def index():
    ...
    if request.method == 'POST':
        ...
        if codes != None:
            ...
            return render_template('index.html', records=records, api1=api1, api2=api2, api3=api3, middle_area = middle_area, budget = budget, name=name)
        else:
            middle_area = data.middle_area_list()
            budget = data.budget_list()
            return render_template('index.html', middle_area=middle_area, budget = budget,name=name)
